"""
Django settings for tamveeb project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[tamveeb] '  # subject prefix for managers & admins

SESSION_COOKIE_NAME = 'tamveeb_ssid'
...
ROOT_URLCONF = 'tamveeb.urls'

WSGI_APPLICATION = 'tamveeb.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "tamveeb <info@TODO.com>"
SERVER_EMAIL = "tamveeb server <server@TODO.com>"
